...
[uqzmezie@bunya2 fastq2Bam]$ nano 04_bwa2samtools-array.sh 
  ...
  GNU nano 2.9.8                               04_bwa2samtools-array.sh                                         

OUTDIR=/scratch/project/phd_coral_genomics/WGS_Stylophora_Taxon1/fastq2Bam/markedRG_bamUSE
REF=/scratch/project/phd_coral_genomics/WGS_Stylophora_Taxon1/reference_genome/GCA_032172095.1_APGP_CSIRO_Spis_$
...
bwa mem -t 2 ${REF} ${INDIR}/${BASE}_R1_paired.fastq.gz ${INDIR}/${BASE}_R2_paired.fastq.gz > ${OUTDIR}/${BASE}$
